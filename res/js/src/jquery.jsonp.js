...
( function( $ ) {
	...
	var // String constants (for better minification)
		...
		// Head element
		head = jQuery( "head" )[ 0 ] || document.documentElement,
		// Page cache
		pageCache = {},
		// Counter
		count = 0,
		...
		// IE < 10
		oldIE = !!jQuery( "<div>" ).html( "<!--[if IE]><i><![endif]-->" ).find("i").length;
	...
	function jsonp( xOptions ) {
		...
		if ( pageCacheFlag && ( pageCached = pageCache[ url ] ) ) {
			...
			opera && opera.version() < 11.60 ?
				...
				( ( scriptAfter = jQuery( STR_SCRIPT_TAG )[ 0 ] ).text = "document.getElementById('" + script.id + "')." + STR_ON_ERROR + "()" )
			:
