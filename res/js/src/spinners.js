  ...
  get: function(element) {
    ...
    jQuery.each(this.spinners, function(i, spinner) {
      if (spinner &&
        ...
        jQuery(spinner.element).is(element) // selector
      )) {
...
jQuery.extend(Collection.prototype, {
  ...
  play: function() {
    jQuery.each(this.items(), function(i, s) { s.play(); });
    return this;
  },

  stop: function() {
    jQuery.each(this.items(), function(i, s) { s.stop(); });
    return this;
  },

  pause: function() {
    jQuery.each(this.items(), function(i, s) { s.pause(); });
    return this;
  },
  
  toggle: function() {
    jQuery.each(this.items(), function(i, s) { s.toggle(); });
    return this;
  },
  
  center: function() {
    jQuery.each(this.items(), function(i, s) { s.center(); });
    return this;
  },
  
  setOptions: function(options) {
    jQuery.each(this.items(), function(i, s) { s.setOptions(options); });
    return this;
  },
...
jQuery.extend(Spinner.prototype, {
  ...
  build: function() {
    ...
    jQuery(document.body).append(this.canvas = jQuery('<canvas>')
